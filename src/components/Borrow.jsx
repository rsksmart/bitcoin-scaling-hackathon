...
let ordVal=0.000079
  ...
  const getLTV = async(ordVal)=>{
    let val = await LendingContract.calculateLoanAmt(ordVal* 10 ** 18)
    setLTV(ethers.formatEther(val.toString(),18))
  }
      ...
      <Flex mt={30}>
        ...
        >
          ...
          <Flex alignItems="center" mb={2}>
            ...
            <Box ml="auto" flexShrink={0} maxWidth="50%" wordBreak="break-word"  >
              <Text>{id}</Text>
            </Box>
          </Flex>
          <Flex alignItems="center" mb={2}>
