    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('collected_xp', models.IntegerField(blank=True, default=0, null=True)),
                ...
                ('related_class', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='attempt', to='class_app.class')),
            ],
        ),
    ]
